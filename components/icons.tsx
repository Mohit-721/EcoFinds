...
export const LeafIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    <path d="M17.61 3.22a.75.75 0 00-1.06-.21l-5.65 4.3a.75.75 0 01-.99.04L4.76 3.05a.75.75 0 00-1.1.13l-2.4 3.6a.75.75 0 00.6 1.22l3.4-.42a.75.75 0 01.76.53l1.8 6.48a.75.75 0 001.4-.4L10.5 8.16a.75.75 0 01.68-.6l5.72-1.78a.75.75 0 00.55-1.02l-1.84-3.54zM22.5 12a.75.75 0 00-.75-.75h-7.5a.75.75 0 000 1.5h6.08l-5.3 5.3a.75.75 0 001.06 1.06l5.3-5.3v6.08a.75.75 0 001.5 0v-7.5z" />
  </svg>
);
...
export const DeleteIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path fillRule="evenodd" d="M16.5 4.478v.227a48.816 48.816 0 013.878.512.75.75 0 11-.256 1.478l-.209-.035-1.005 13.006a.75.75 0 01-.749.654H5.25a.75.75 0 01-.749-.654L3.495 6.66l-.209.035a.75.75 0 01-.256-1.478A48.567 48.567 0 017.5 4.705v-.227c0-1.564 1.213-2.9 2.816-2.9h1.368c1.603 0 2.816 1.336 2.816 2.9zM5.25 6.75h13.5v13.5H5.25V6.75z" clipRule="evenodd" />
    </svg>
);
